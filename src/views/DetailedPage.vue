  ...
  <div class="container">
    <div id="header" class="detailed-main">
      ...
      <div class="column-layout">
        ...
        <div class="buttonList">
          <router-link class="head-top-md" to="/shoppingcart"
            >장바구니</router-link
          >
          <router-link class="head-top-md" to="/"
            ><i class="fa-solid fa-gift"></i>선물하기</router-link
          >
    ...
    <div class="detailedcenter">
      ...
      <div class="detailedimg">
        <img
          src="https://irecipe.com/mobile/upload/pd/20231027_event_pdtop_1.jpg"
          style="width: 1200px"
        />
        <img
          src="https://irecipe.com/mobile/upload/pd/20230823CleansingBalm_1.jpg"
          style="width: 1200px"
        />
      </div>
      <div class="eventlist">
      ...
      <div class="detaileditem">
        ...
        <div class="itemprice">
          <span>결제안내</span>
          <span
            >무통장 입금, 신용카드, 네이버페이, 실시간 계좌이체, 휴대폰 결제를
            통해 결제 하실 수 있습니다.<br />
            무통장 입금 주문시 주문 후 3일 이내로 입금을 하셔야 하며 입금되지
            않은 주문은 자동취소 되는 점 유의바랍니다.<br />
            주문시 입력한 입금자명과 실제 입금자의 성명이 다른 경우 배송이
            지연될 수 있으니 반드시 전화문의나 CS Center > 상품Q&A에
            남겨주세요<br />
        ...
        <div class="itemdelivery">
          ...
          <div class="itemevent">
            <span>배송 안내</span>
            <span
              >3만원 이상 무료배송 / 3만원 미만 주문시 배송비 3,500원이
              부과됩니다.<br />
              오후 12시까지 입금 확인 된 주문 건에 한해 당일 발송됩니다. 교환 및
              반품 시에는 배송비 3,000원이 부과될 수 있습니다.
            </span>
          </div>
        </div>
        <div class="itemchange">
          ...
          <div class="itemevent">
            ...
            <span
              ...
              - 단순 변심, 착오 구매에 따른 교환/반품은 상품을 공급 받으신
              날로부터 10일 이내 가능합니다.<br />
              (왕복 배송비 6,000원 소비자 부담) 단, 일부 제품의 경우 포장을
              개봉하였거나 포장이 훼손되어 상품가치가 상실된 경우에는
              교환/반품이 불가능합니다.<br />
              - 공급받으신 상품 및 용역의 내용이 표시.광고 내용과 다르거나
              다르게 이행된 경우에는 공급받은 날로부터 3월이내, 그사실을 알게 된
              날로부터 30일이내 청약철회가 가능합니다.<br />
              (반품/교환 배송비 회사 부담)<br />
              ...
              <b>주의사항</b><br />
              - 상품 교환/반품 시에는 고객센터 (1522-2097)로 문의하신 후
              보내주셔야 원활히 처리됩니다.<br />
